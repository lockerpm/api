...
class AbstractCollectionCipherORM(models.Model):
    collection = models.ForeignKey(
        locker_server_settings.LS_COLLECTION_MODEL, on_delete=models.CASCADE, related_name="collections_ciphers"
    )
    cipher = models.ForeignKey(
        locker_server_settings.LS_CIPHER_MODEL, on_delete=models.CASCADE, related_name="collections_ciphers"
    )
