...
class PolicyMasterPassword(models.Model):
    policy = models.OneToOneField(
        EnterprisePolicy, to_field='id', primary_key=True, related_name="policy_master_password_requirement",
    ...
    def create(cls, policy, **kwargs):
        new_policy_master_password = cls(
            policy=policy,
        ...
        new_policy_master_password.save()
        return new_policy_master_password
