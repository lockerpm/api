...
class UserAccessToken(models.Model):
    """
    The AccessToken is generated by a RefreshToken (Device). It represents a session and stores some information about
    the user and device in access_token
    - access_token: JWT Token string stores the user's information and device's information
    - expired_time: The expired time
    - granted_type: It usually is refresh_token
    - refresh_token: The RefreshToken object
    ...
    def create(cls, refresh_token: UserRefreshToken,  **data):
        ...
        new_token = cls(
            ...
            refresh_token=refresh_token, sso_token_id=sso_token_id
        )
        new_token.save()
